...
# Коди регіонів (перші 2 літери) — ДОСЛІВНО з офіційного наказу МВС №166, Додаток 4
# (чинна редакція 16.12.2025). Активні першими, далі резервні/майбутні. 108 кодів,
# без дублів, 0 конфліктів із 20+ млн реальних номерів.
REGION_SERIES: dict = {
    "АР Крим": ["АК", "МА", "ТК", "МК"],
