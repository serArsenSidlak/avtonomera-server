...
#   Коди регіонів (Додаток 4). Звірено з реальною базою: усі 36 наявних у БД префіксів збігаються
#   (0 розбіжностей), без дублів між регіонами. 3-тю/4-ту серію взято з довідкового джерела —
#   підлягає звірці з офіційним Додатком 4 (ще не всі видані, тож у БД їх поки немає).
REGION_SERIES: dict = {
    "м. Київ": ["АА", "КА", "ТТ", "ТА"],
